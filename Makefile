...
# Template: app
# Command: /usr/bin/qmake-qt5 -o Makefile SerialTest.pro CONFIG+=release QT+=designer
#############################################################################
...
INCPATH       = -I. -I/mnt/ubuntustudio/home/roman/Dokumente/Sources/SerialScope/Source/serial/include -isystem /usr/include/qt/QtCore/5.12.0 -isystem /usr/include/qt/QtCore/5.12.0/QtCore -isystem /usr/include/qt -isystem /usr/include/qt/QtCore -I. -I/usr/lib/qt/mkspecs/linux-g++
...
DISTDIR = /mnt/ubuntustudio/home/roman/Dokumente/Sources/SerialScope/.tmp/SerialTest1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-O1,--sort-common,--as-needed,-z,relro,-z,now
LIBS          = $(SUBLIBS) -lQt5Core -lpthread -lgdi32 -lcomdlg32 -lsetupapi  
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
Makefile: SerialTest.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile SerialTest.pro CONFIG+=release QT+=designer
...
distdir: FORCE
	...
	$(COPY_FILE) --parents Source/serial/include/serial/impl/unix.h Source/serial/include/serial/impl/win.h Source/serial/include/serial/serial.h Source/serial/include/serial/v8stdint.h Source/serialib/serialib.h $(DISTDIR)/
	$(COPY_FILE) --parents Source/SerialTest.cpp Source/serial/src/impl/unix.cc Source/serial/src/impl/win.cc Source/serial/src/serial.cc Source/serialib/serialib.cpp $(DISTDIR)/
...
SerialTest.o: Source/SerialTest.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o SerialTest.o Source/SerialTest.cpp

unix.o: Source/serial/src/impl/unix.cc 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o unix.o Source/serial/src/impl/unix.cc

win.o: Source/serial/src/impl/win.cc 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o win.o Source/serial/src/impl/win.cc

serial.o: Source/serial/src/serial.cc 
